function hsl_ma48_install(varargin)
%
%   hsl_ma48_install installs hsl_ma48.
%
%   VARARGIN
%
...
if(g95_fix)
   ...
   % ddeps90.g95.f90 and common90.g95.f90 contain an alternate versions of
   % hsl_zb01 that works around this bug (in a manner that is not sadly not
   % compatible with other compilers!)
   do_unix_cmd('cp ddeps90.g95.f90 ddeps90.f90');
   do_unix_cmd('cp common90.g95.f90 common90.f90');
   mexcompile(MEXFLAGS, '-c', 'ddeps90.f90', '')
   mexcompile(MEXFLAGS, '-c', 'common90.f90', '')
   do_unix_cmd('rm ddeps90.f90 common90.f90');
else
   mexcompile(MEXFLAGS, '-c', [srcdir,'/ddeps90.f90'], '')
   mexcompile(MEXFLAGS, '-c', [srcdir,'/common90.f90'], '')
end
mexcompile(MEXFLAGS, '-c', [srcdir,'/hsl_ma48d.f90'], '')
mexcompile(MEXFLAGS, '-c', 'hsl_matlab.F90', '')
mexcompile(MEXFLAGS, '-output hsl_ma48_expert', 'hsl_ma48_expert.f90 hsl_matlab.o hsl_ma48d.o ddeps.o ddeps90.o common90.o', LIBS)
